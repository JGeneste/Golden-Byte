...
public class SignUp extends Activity implements OnClickListener{
	...
	private void createAccount(){
		...
		if (cancel) {
			...
			signUp(mUsername.toLowerCase(Locale.getDefault()), mEmail, mPassword, mChecking);

		}

	}

	private void signUp(final String mUsername, String mEmail, String mPassword, String checking) {
		// TODO Auto-generated method stub
        ...
        /*ParseQuery<ParseObject> query = ParseQuery.getQuery(mUsername);
